...
class ProfileFactory(factory.django.DjangoModelFactory):
    ...
    profile_photo = factory.lazy_attribute(
    ...
    is_agent = False
    top_agent = False
    ratings = factory.lazy_attribute(lambda x: faker.random_int(min=1, max=5))
    num_reviews = factory.lazy_attribute(lambda x: faker.random_int(min=0, max=25))
...
class UserFactory(factory.django.DjangoModelFactory):
    ...
    email = factory.lazy_attribute(lambda x: f"test@test.com")
