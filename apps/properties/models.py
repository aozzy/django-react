...
class Property(TimeStampedUUIDModel):
    ...
    city = models.CharField(verbose_name=_("City"), max_length=180, default="London")
    postal_code = models.CharField(verbose_name=_("Post code"), max_length=100, default="SW1")
    street_address = models.CharField(verbose_name=_("Address"), max_length=150, default="somewhere in london")
    ...
    tax = models.DecimalField(verbose_name=("Property tax"), max_digits=6, decimal_places=2, default=0.15, help_text="15% property tax charged")
    ...
    photo_1 = models.ImageField(verbose_name=_("Main photo"), default="/interior_sample.jpg",null= True,blank=True)
    photo_2 = models.ImageField(verbose_name=_("Main photo"), default="/interior_sample.jpg",null= True,blank=True)
    photo_3 = models.ImageField(verbose_name=_("Main photo"), default="/interior_sample.jpg",null= True,blank=True)
    photo_4 = models.ImageField(verbose_name=_("Main photo"), default="/interior_sample.jpg",null= True,blank=True)
