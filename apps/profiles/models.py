...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name= _("Phone Number"), max_length=30, default="+447911111199")
    about_me = models.TextField(verbose_name= _("About Me"), default= "Introduce yourself")
    license = models.CharField(verbose_name= _("My License"), max_length=20, blank=True, null=True)
    ...
    city = models.CharField(verbose_name=_("City"), max_length=180, default="London", blank=False,null=False)
    is_buyer = models.BooleanField(verbose_name=_("Buyer"), default=False, help_text=_("Are you a buyer?"))
    is_seller = models.BooleanField(verbose_name=_("Seller"), default=False, help_text=_("Are you a buyer?"))
